...
echo "<center>";
echo "<h2 style='font-family: Arial, sans-serif; color: #333;'>Edit Course</h2>";
...
echo "<tr><td>Course Code:</td><td><input type='text' name='course_code' value='".$course["course_code"]."' /></td></tr>";
echo "<tr><td>Course Name:</td><td><input type='text' name='course_name' value='".$course["course_name"]."' /></td></tr>";
